...
def public_fn_with_googley_docstring2(name, state=None):
...
def public_fn_with_sphinxy_docstring2(name, state=None):
    """This function does something.
...
def public_fn_without_docstring2():
    return True


def _private_fn_with_docstring2(foo, bar='baz', foobarbas=None):
    """I have a docstring, but won't be imported if you just use ``:members:``.
    """
    return None


class MyPublicClass2(object):
